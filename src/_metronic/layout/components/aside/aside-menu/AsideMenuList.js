  ...
  return (
    <>
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        >
          ...
          <div className="menu-submenu">
            <ul className="menu-subnav">
              <ul className="menu-subnav">
                <li
                  className={`menu-item ${getMenuItemActive("/cities")}`}
                  aria-haspopup="true"
                >
                ...
                {/*end::2 Level*/}
                <li
                  className={`menu-item ${getMenuItemActive("/busTypes")}`}
                  aria-haspopup="true"
                >
                ...
                {/*end::2 Level*/}
                <li
                  className={`menu-item ${getMenuItemActive("/buses")}`}
                  aria-haspopup="true"
                >
                ...
                {/*end::2 Level*/}
                <li
                  className={`menu-item ${getMenuItemActive("/drivers")}`}
                  aria-haspopup="true"
                >
                ...
                <li
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/directions">
                    <span className="svg-icon menu-icon">
                      <SVG
                        src={toAbsoluteUrl(
                          "/media/svg/icons/Shopping/Box2.svg"
                    ...
                    <span className="menu-text">مسیرها</span>
                  </NavLink>
                </li>
              </ul>
            </ul>
        ...
        <li
          className={`menu-item ${getMenuItemActive("/travels", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/travels">
            <span className="svg-icon menu-icon">
