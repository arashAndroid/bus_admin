...
function BusTypesTable(props) {
      ...
      formatter: (cell, row, rowIndex, formatExtraData) => {
        return (
          <>
            <OverlayTrigger
              overlay={
                <Tooltip id="products-edit-tooltip">ویرایش نوع اتوبوس</Tooltip>
              }
            >
              <a
            ...
            <OverlayTrigger
              overlay={
                <Tooltip id="products-delete-tooltip">حذف نوع اتوبوس</Tooltip>
              }
            >
              <a
  ...
  return (
    <>
      <Card>
        <CardHeader title="لیست نوع اتوبوس ها">
          <CardHeaderToolbar>
            <button
              type="button"
      ...
      >
        <DialogTitle id="alert-dialog-slide-title">
          {"آیا واقعا قصد حذف این نوع اتوبوس را دارید ؟"}
        </DialogTitle>
        <DialogContent>
        ...
        <DialogActions>
          ...
          <Button
            onClick={() => removeBusType(current.id)}
          ...
          <>
            ...
            <Modal show={editOpen} onHide={handleEditClose}>
              <Modal.Header closeButton>
                <Modal.Title>
                  {editMode ? "ویرایش نوع اتوبوس" : "افزودن نوع اتوبوس"}
                </Modal.Title>
              </Modal.Header>
              <Modal.Body>
