...
import { getAllTownships, addTownship, editTownship, deleteTownship, getProvinces } from "./_redux/townshipsCrud";
...
function TownshipsTable(props) {
...

    {
        ...
        formatter: (cell, row, rowIndex, formatExtraData) => {
            ...
            return (
                <>
                    <OverlayTrigger
                        overlay={<Tooltip id="products-edit-tooltip">ویرایش شهرستان</Tooltip>}
                    >
                        <a
                    ...
                    <OverlayTrigger
                        overlay={<Tooltip id="products-delete-tooltip">حذف شهرستان</Tooltip>}
                    >
                        <a
    ...
    return (
        <>
            <Card>
                <CardHeader title="لیست شهرستان ها">
                    <CardHeaderToolbar>
                        <button
                            type="button"
          ...
          <>
            ...
            >
                <DialogTitle id="alert-dialog-slide-title">{"آیا واقعا قصد حذف این شهرستان را دارید ؟"}</DialogTitle>
                <DialogContent>
                ...
                <DialogActions>
                    ...
                    <Button onClick={() => removeTownship(current.Id)} className="btn btn-danger" color="danger">
                        حذف
          </Button>
                </DialogActions>
            </Dialog>
