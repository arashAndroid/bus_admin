...
import { getAllServants, getTownships, addServants, editServants, deleteServants } from "./_redux/servantsCrud";
...

    {
        ...
        formatter: (cell, row, rowIndex, formatExtraData) => {
            ...
            return (
                <>
                    <OverlayTrigger
                        overlay={<Tooltip id="products-edit-tooltip">ویرایش خدمه</Tooltip>}
                    >
                        <a
    ...
    return (
        <>
          ...
          <>
            ...
            >
                <DialogTitle id="alert-dialog-slide-title">{"آیا واقعا قصد حذف این خدمه را دارید ؟"}</DialogTitle>
                <DialogContent>
                ...
                <DialogActions>
                    ...
                    <Button onClick={() => removeServant(current.Id)} className="btn btn-danger" color="danger">
                        حذف
          </Button>
                </DialogActions>
            </Dialog>
