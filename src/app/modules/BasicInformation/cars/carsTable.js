...
function CarsTable(props) {
...

    {
        ...
        formatter: (cell, row, rowIndex, formatExtraData) => {
            ...
            return (
                <>
                    <OverlayTrigger
                        overlay={<Tooltip id="products-edit-tooltip">ویرایش خودرو</Tooltip>}
                    >
                        <a
                    ...
                    <OverlayTrigger
                        overlay={<Tooltip id="products-delete-tooltip">حذف خودرو</Tooltip>}
                    >
                        <a
    ...
    return (
        <>
            <Card>
                <CardHeader title="لیست خودرو ها">
                    <CardHeaderToolbar>
                        <button
                            type="button"
          ...
          <>
            ...
            >
                <DialogTitle id="alert-dialog-slide-title">{"آیا واقعا قصد حذف این خودرو را دارید ؟"}</DialogTitle>
                <DialogContent>
                                ...
                                <Form className="form form-label-right">
                                    <div className="form-group row">
                                        <div className="col-lg-4">
                                            <Select name="CarBrandId" label="برند">
                                        ...
                                        <div className="col-lg-4">
                                            <Select name="CarTypeId" label="نوع">
